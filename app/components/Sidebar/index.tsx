...
function Sidebar() {
  ...
  return (
    <div className="bg-light border-right" id="sidebar-wrapper">
      <div className="sidebar-heading pt-5 pb-4"><strong>Cognizant Bank</strong></div>
      <div className="list-group list-group-flush">
        {(currentUser === undefined) ? <>
          ...
          <>
            ...
            <NavLink to="/apply_loan" className={`tabs list-group-item ${(location.pathname === '/apply_loan') ? 'active1' : 'bg-light'}`}>
              <div className="list-div my-2">
                <FontAwesomeIcon icon={["fas", "plus-square"]} /> &nbsp;&nbsp; Apply Loan
              </div>
            </NavLink>
            <NavLink to="/deposit" className={`tabs list-group-item ${(location.pathname === '/deposit') ? 'active1' : 'bg-light'}`}>
              <div className="list-div my-2">
                <FontAwesomeIcon icon={["fas", "upload"]} /> &nbsp;&nbsp;&nbsp; Deposit Amount
              </div>
            </NavLink>
